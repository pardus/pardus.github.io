<footer class="w-full flex flex-col items-center">
    <span class="mt-20">Pardus © Copyleft 2023</span>
    <div class="flex flex-wrap items-center justify-center md:gap-3 gap-x-2 ">
        <svg
            class="gitsvg"
        ...
        >
            ...
            <sodipodi:namedview
                ...
                id="namedview29"
                showgrid="false"
                inkscape:zoom="2.3287671"
                inkscape:cx="110.88801"
                inkscape:cy="71.579757"
                inkscape:window-x="0"
                inkscape:window-y="0"
            ...
            <g id="g40" transform="translate(0,-0.79)">
                <path
        ...
        <svg
            ...
            width="116.57742mm"
            height="30.563242mm"
            viewBox="0 0 116.57742 30.563242"
            version="1.1"
            id="svg216"
        ...
        >
            <sodipodi:namedview
                ...
                inkscape:cx="197.34404"
                inkscape:cy="206.04056"
                inkscape:window-width="1920"
            ...
            <defs id="defs213">
                ...
                >
                    <stop style="stop-color:#5a9fd4" offset="0" id="stop11" />
                    <stop style="stop-color:#306998" offset="1" id="stop13" />
                </linearGradient>
                <linearGradient
                    id="vlpc"
                    x1="151"
                    ...
                    gradientUnits="userSpaceOnUse"
                >
                    <stop style="stop-color:#ffd43b" offset="0" id="stop6" />
                    <stop style="stop-color:#ffe873" offset="1" id="stop8" />
                </linearGradient>
            </defs>
            <g
                ...
                id="layer1"
                transform="translate(-52.958272,-93.759962)"
            >
                <g
                    id="g55"
                    transform="matrix(0.26458333,0,0,0.26458333,51.478615,92.89742)"
                >
                    <path
        ...
        <svg
            ...
            height="33.354984"
            width="139.09288"
            viewBox="-13.28 -21.779 139.09056 33.354984"
            version="1.1"
            id="svg6"
        ...
        >
            ...
            <sodipodi:namedview
                ...
                inkscape:cx="74.935789"
                inkscape:cy="24.771405"
                inkscape:window-x="0"
                inkscape:window-y="0"
                inkscape:window-maximized="1"
            ...
            <g id="g13">
                <path
                    d="m 3.925,-21.263 c -9.22,0 -16.69,7.473 -16.69,16.6919999 0,7.155 4.504,13.2560001 10.83,15.6300001 L 1.908,0.8019999 A 5.74,5.74 0 0 1 3.924,-10.308 5.74,5.74 0 0 1 5.9390005,0.8029999 L 9.7860005,11.06 C 16.112,8.687 20.616,2.5849999 20.616,-4.5700001 20.616,-13.788 13.143,-21.26 3.924,-21.26 Z"
                    fill="#40aa54"
                    stroke="#20552a"
                    stroke-width="1.032"
